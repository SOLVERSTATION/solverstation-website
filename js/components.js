...
(function () {
  ...
  function logoSVG(size = 36) {
    return `<svg width="${size}" height="${size}" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <circle cx="18" cy="8"  r="3.5" fill="#0080FE"/>
      <circle cx="6"  cy="26" r="3.5" fill="#0080FE"/>
      <circle cx="30" cy="26" r="3.5" fill="#0080FE"/>
      <circle cx="18" cy="22" r="2.5" fill="rgb(27,27,27)"/>
      <line x1="18" y1="11.5" x2="18" y2="19.5" stroke="#0080FE" stroke-width="1.8"/>
      <line x1="15.5" y1="23.5" x2="8.2"  y2="23.5" stroke="#0080FE" stroke-width="1.8"/>
      <line x1="20.5" y1="23.5" x2="27.8" y2="23.5" stroke="#0080FE" stroke-width="1.8"/>
      <line x1="16.3" y1="9.7"  x2="7.3"  y2="23.3" stroke="#0080FE" stroke-width="1.2" stroke-dasharray="2 2"/>
      <line x1="19.7" y1="9.7"  x2="28.7" y2="23.3" stroke="#0080FE" stroke-width="1.2" stroke-dasharray="2 2"/>
    </svg>`;
  }
  ...
  function rootPath() {
    ...
    const subFolders = ['solutions', 'company', 'resources'];
    const inSub = pathParts.some(p => subFolders.includes(p));
    return inSub ? '../' : './';
  }
        ...
        <ul class="nav-menu" id="nav-menu" role="menubar">
          ...
          <li class="nav-item" role="none">
            ...
            <ul class="dropdown" role="menu">
              <li><a href="${r}solutions/mech-eng-naval.html"        class="dropdown-item" role="menuitem" data-key="sol_mech">${t.sol_mech}</a></li>
              <li><a href="${r}solutions/research-development.html"  class="dropdown-item" role="menuitem" data-key="sol_rd">${t.sol_rd}</a></li>
              <li><a href="${r}solutions/maintenance-asset.html"     class="dropdown-item" role="menuitem" data-key="sol_maint">${t.sol_maint}</a></li>
              <li><a href="${r}solutions/project-lifecycle.html"     class="dropdown-item" role="menuitem" data-key="sol_plm">${t.sol_plm}</a></li>
              <li><a href="${r}solutions/ai-solutions.html"          class="dropdown-item" role="menuitem" data-key="sol_ai">${t.sol_ai}</a></li>
              <li><a href="${r}solutions/digital-solutions.html"     class="dropdown-item" role="menuitem" data-key="sol_digital">${t.sol_digital}</a></li>
            </ul>
          </li>

          <!-- PRODUCTS -->
          <li class="nav-item" role="none">
            <a href="${r}products.html" class="nav-link" role="menuitem" data-key="nav_products">${t.nav_products}</a>
          </li>

          <!-- PARTNERS -->
          <li class="nav-item" role="none">
            <a href="${r}partners.html" class="nav-link" role="menuitem" data-key="nav_partners">${t.nav_partners}</a>
          </li>
          ...
          <li class="nav-item" role="none">
            ...
            <ul class="dropdown" role="menu">
              <li><a href="${r}company/about.html"           class="dropdown-item" role="menuitem" data-key="comp_about">${t.comp_about}</a></li>
              <li><a href="${r}company/values.html"          class="dropdown-item" role="menuitem" data-key="comp_values">${t.comp_values}</a></li>
              <li><a href="${r}company/global-presence.html" class="dropdown-item" role="menuitem" data-key="comp_global">${t.comp_global}</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item" role="none">
            ...
            <ul class="dropdown" role="menu">
              <li><a href="${r}resources/news.html"    class="dropdown-item" role="menuitem" data-key="res_news">${t.res_news}</a></li>
              <li><a href="${r}resources/events.html"  class="dropdown-item" role="menuitem" data-key="res_events">${t.res_events}</a></li>
              <li><a href="${r}resources/library.html" class="dropdown-item" role="menuitem" data-key="res_library">${t.res_library}</a></li>
            </ul>
          </li>

          <!-- CONTACT -->
          <li class="nav-item" role="none">
            <a href="${r}contact.html" class="nav-link nav-link-cta" role="menuitem" data-key="nav_contact">${t.nav_contact}</a>
          </li>
